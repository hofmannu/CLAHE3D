...
TEST_CASE("meanfilt stays in bounds and matches a hand-computed mean", "[meanfilt]")
{
	...
	INFO("reference mean = " << testMean << ", filter result = " << valueProc);
	REQUIRE(errorVal <= 1e-6f);
